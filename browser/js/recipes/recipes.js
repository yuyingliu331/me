...
app.controller('recipesCtrl', function($scope){
  $scope.apps = [
    ...
    { name: 'Bruschetta', link: 'http://www.simplyrecipes.com/recipes/bruschetta_with_tomato_and_basil/%22'},
  ...
  $scope.sides = [
    { name: 'Sweet Potato Fries', link: 'http://www.foodnetwork.com/recipes/food-network-kitchens/fresh-corn-tomato-salad-recipe.html'},
    { name: 'Chicken Salad (my own recipe)', link: ''},
    { name: 'Brussel Sprouts', link: 'http://www.foodnetwork.com/recipes/food-network-kitchens/fresh-corn-tomato-salad-recipe.html%22'},
